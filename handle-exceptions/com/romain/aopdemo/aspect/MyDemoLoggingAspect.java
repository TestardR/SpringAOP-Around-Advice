...
public class MyDemoLoggingAspect {
	...
	@Around("execution(* com.romain.aopdemo.service.*.getFortune(..))")
	...
	@After("execution(* com.romain.aopdemo.dao.AccountDAO.findAccounts(..))")
	...
	@AfterThrowing(
			pointcut="execution(* com.romain.aopdemo.dao.AccountDAO.findAccounts(..))",
			throwing="theExc")
